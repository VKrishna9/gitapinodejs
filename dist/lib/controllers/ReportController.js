...
var ReportController = /** @class */ (function () {
    function ReportController(ReportRepository) {
        this.ReportRepository = ReportRepository;
    }
    ReportController.prototype.getRports = function (user, sch) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 5];
                    case 1: return [4 /*yield*/, this.ReportRepository.getSearchReports()];
    ...
    ], ReportController.prototype, "getRports", null);
    ReportController = __decorate([
        routing_controllers_1.JsonController("/reports"),
        typedi_1.Service(),
