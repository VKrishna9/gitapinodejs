...
var SearchRepository = /** @class */ (function () {
    ...
    SearchRepository.prototype.getSearchData = function (sch) {
        return __awaiter(this, void 0, void 0, function () {
            var searchUrl, options;
            return __generator(this, function (_a) {
                searchUrl = "https://api.github.com/search/repositories?q=" + sch.getSch() + "+language:" + sch.getSch2() + "&sort=stars&order=desc&page=1&per_page=30";
                ...
                try {
                    return [2 /*return*/, request.get(options)
                            .on('response', function (error, response) {
                            if (error) {
                                //throw new Error();
                            }
                            LogUtils_1.logger.info(JSON.stringify(response));
                            ReportRepository_1.ReportRepository.prototype.saveRecord(sch, response);
                            return JSON.stringify(response);
                        })];
                }
                catch (exception) {
                    throw new TokenChecker_1.CustomeError(404, "");
                }
                return [2 /*return*/];
            });
        });
